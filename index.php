    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Inicio</a>
              <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-controls="navigation" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-bar bar1"></span><span class="navbar-toggler-bar bar2"></span><span class="navbar-toggler-bar bar3"></span></button>
            </div>
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link smooth-scroll" href="#sobre mi">Sobre mi</a></li>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/portada.jpg')"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/Diego.jpg" alt="Image"/></a></div>
          <div class="h2 title">&lt; Diego Sandoval /&gt;</div>
          <p class="category text-white">Ingeniero de Sistemas y Desarrollador Junior</p><a class="btn btn-primary" href="H.V Diego Alejandro Sandoval Fernández.docx" download data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Descargar CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
          <div class="button-container">
            <a class="btn btn-default btn-round btn-lg btn-icon" href="https://interacpedia.com/user/diego-alejandro-sandoval-fernandez" rel="tooltip" title="Interacpedia"><img src="https://pbs.twimg.com/profile_images/1125491311237373952/zvDqi6_y_400x400.png" alt="Interacpedia"/></a>
            <a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.linkedin.com/in/diego-alejandro-sandoval-fern%C3%A1ndez-1b4374201/" rel="tooltip" title="Linkedin"><i class="fa fa-linkedin"></i></a>
            <a class="btn btn-default btn-round btn-lg btn-icon" href="https://github.com/AlexDeimon" rel="tooltip" title="Github"><img src="https://img.icons8.com/ios-filled/90/000000/github.png" alt="icono-github"/></a>
            </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Soy estudiante de ingeniería de sistemas de la Universidad Libre de Colombia.</p> <p>Soy un programador junior con la intención de llegar a ser senior. Soy autodidacta y trabajo en proyectos de desarrollo propios y en equipo, siempre aprendiendo más cada día.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-3"><strong class="text-uppercase">Edad:</strong></div>
              <div class="col-sm-9">21</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-3"><strong class="text-uppercase">Email:</strong></div>
              <div class="col-sm-9">diegoalejandro1999@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-3"><strong class="text-uppercase">Teléfono:</strong></div>
              <div class="col-sm-9">+57 3134473607</div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title">Áreas de interes</div>
            <div class="row">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Programación</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Investigación</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Redes sociales</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Sistemas</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Desarrollo de software</strong></li></ul></div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            <div class="h4 mt-0 title">Habilidades blandas</div>
            <div class="row">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Orden</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">autodidacta</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Atento al detalle</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Actitud positiva</strong></li></ul></div>
            </div>
            <div class="row mt-1">
              <div class="col-sm-12"><ul><li><strong class="text-uppercase">Capacidad de trabajar en equipo</strong></li></ul></div>
            </div>
          </div>
        </div>
      </div>
...
<div class="section" id="habilidades">
  <div class="container">
    <div class="h4 text-center mb-4 title">Habilidades técnicas</div>
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Mockups</span>
              <div class="progress">
  ...
  <div class="container cc-experience">
    <div class="row">
      <div class="col-md-6 ml-auto mr-auto">
        <div class="h4 text-center mb-4 title">Proyectos</div>
      </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>Febrero 2021 - Presente</p>
            <div class="h5">Aplicación web</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"><a href="https://gamezone-ms-app.herokuapp.com/">Game Zone</a></div>
            <p>Esta aplicación permite que un usuario de alguna tienda de videojuegos pueda gestionar clientes, productos, compras y envíos de forma sencilla gracias a una interfaz intuitiva. Se desarrolló en el lenguaje de programación Python junto con el framework Vue.js</p>
            <p><strong class="text-uppercase">En progreso...</strong></p>
            <p><strong class="text-uppercase">No actualizar ni eliminar registros.</strong></p>
            <p><strong class="text-uppercase">No es responsive.</strong></p>
          </div>
        </div>
      </div>
    </div>
...
<div class="section" id="education">
  <div class="container cc-education">
    <div class="h4 text-center mb-4 title">Formación Académica</div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            ...
            <div class="h6">sexto semestre</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body" style="background-image: url('images/universidad-libre.jpg'); background-size: cover">
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2020</p>
            <div class="h6">Diplomado PROGRAMA DE CONOCIMIENTO ACADÉMICO EN HABILIDADES DE PROGRAMACIÓN DE MISIÓN TIC 2022.</div>
            <div class="h6">Universidad Nacional</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body"style="background-image: url('images/misiontic.jpg'); background-size: cover">
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">+57 3134473607</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>diegoalejandro1999@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
